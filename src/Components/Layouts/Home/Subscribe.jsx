...
const Subscribe = () => {
  return (
    ...
    <Image src={Dot} alt={Dot} className='absolute top-3 left-[-50px]' />
        ...
        <Flex>
             {/* SubsCribe Part Left Side Image Start */}
            <Flex className="w-60%">
            ...
            {/* SubsCribe Part Left Side Image End */}

            
            <div className="40%">
                {/* Subscribe Part Right Side Text Start */}
                ...
                <Paragraph text='The Brilliant reasons Entrada should be your one-stop-shop!' className='pl-8 pt-12 w-[500px] '/>
                 {/* Subscribe Part Right Side Text End */}

                {/* Subscribe Email Box Part Start */}
